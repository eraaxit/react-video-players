...
var throwPlayerPropsError = function () {
    throw new Error("sourceUrl prop must be passed into a player component.");
};

var YT = function (_a) {
    var sourceUrl = _a.sourceUrl, _b = _a.createObjectUrl, createObjectUrl = _b === void 0 ? false : _b;
    var _c = react.exports.useState(""), url = _c[0], setUrl = _c[1];
    var videoRef = react.exports.useRef(null);
    var createUrlObject = react.exports.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, blob, _url;
    ...
    react.exports.useEffect(function () {
        if (!sourceUrl)
            throwPlayerPropsError();
        if (!createObjectUrl)
            return setUrl(sourceUrl);
        createUrlObject();
    }, [sourceUrl, createUrlObject, createObjectUrl]);
    return (React.createElement("div", null, url ? (React.createElement(React.Fragment, null,
        React.createElement("video", { autoPlay: true, ref: videoRef },
            React.createElement("source", { src: url, type: "video/mp4" })),
        React.createElement("button", { onClick: function () { var _a; return (_a = videoRef.current) === null || _a === void 0 ? void 0 : _a.play(); } }, "Play"),
        React.createElement("button", { onClick: function () { var _a; return (_a = videoRef.current) === null || _a === void 0 ? void 0 : _a.pause(); } }, "Pause"))) : (React.createElement("p", null, "Loading video..."))));
};
